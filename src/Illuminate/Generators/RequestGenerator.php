...
class RequestGenerator extends AbstractGenerator
{
    ...
    {
        return match ($type) {
            'array', 'json' => [TypeScriptType::array(), TypeScriptType::ANY],
            'string', 'binary', 'blob', 'date', 'datetime', 'guid', 'text' => TypeScriptType::STRING,
            'bigint', 'decimal', 'float', 'integer', 'smallint' => TypeScriptType::NUMBER,
